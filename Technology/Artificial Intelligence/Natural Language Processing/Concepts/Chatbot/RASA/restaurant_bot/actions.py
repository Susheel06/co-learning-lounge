...
class BingLocationExtractor:
    ...
    def __init__(self):
       ...
       self.bing_api_key="AsniRL7W7alPPTn8T-IIvT8PeUHmm9X9-imeU40K8JetuWdoYXOnTE3Xa6FL931X" ## Update Bing API key here
...
class Zomato:
    ...
    def __init__(self):
        self.api_key="f3c6ba2a83f694af8e6645f4d06c0c84"  ## Update Zomato API key here
